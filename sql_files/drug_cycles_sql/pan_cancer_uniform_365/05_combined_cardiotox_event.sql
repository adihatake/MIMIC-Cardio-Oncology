-- 05_combined_cardiotox_event.sql  (pan_cancer_uniform_365)
--
...
--
-- Main output:
--   pcu_first_combined_cardiotox_event

CREATE OR REPLACE VIEW pcu_first_combined_cardiotox_event AS
SELECT
    p.subject_id,
...
LEFT JOIN pcu_incident_hf_events          hf   ON p.subject_id = hf.subject_id
LEFT JOIN pcu_first_echo_cardiotox_event  echo ON p.subject_id = echo.subject_id;
