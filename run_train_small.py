...
Small model (arch S) baseline across all pan_cancer_ctrcd tokenization variants.

Tokenization variants (produced by run_tokenization.py):
    pan_cancer_ctrcd_v1_all_labs            — all labs, no bucketing
    pan_cancer_ctrcd_v1_cardiac_labs        — cardiac-only labs, no bucketing
    pan_cancer_ctrcd_v1_bucketed_all_labs   — all labs, bucketed values
    pan_cancer_ctrcd_v1_bucketed_cardiac_labs — cardiac-only labs, bucketed values
...
DATASETS = [
    ("all_labs",              "pan_cancer_ctrcd_v1_all_labs"),
    ("cardiac_labs",          "pan_cancer_ctrcd_v1_cardiac_labs"),
    ("bucketed_all_labs",     "pan_cancer_ctrcd_v1_bucketed_all_labs"),
    ("bucketed_cardiac_labs", "pan_cancer_ctrcd_v1_bucketed_cardiac_labs"),
]
