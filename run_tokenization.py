...
RUNS = [
    ...
    TokenizationConfig(**_BASE, output_name="pan_cancer_ctrcd_v3_bucketed_all_labs",
                       bucket_labs=True,
                       bucket_medications=True,
                       cardiac_labs_only=False),
    TokenizationConfig(**_BASE, output_name="pan_cancer_ctrcd_v3_bucketed_cardiac_labs",
                       bucket_labs=True,
                       bucket_medications=True,
